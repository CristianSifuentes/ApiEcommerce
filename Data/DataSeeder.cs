...
// Clase para realizar el seeding de datos iniciales
// incluyendo roles, categorías, usuarios y productos.
// Esta clase es llamada desde ApplicationDbContext durante la inicialización.
// Asegura que la base de datos tenga datos esenciales para el funcionamiento de la aplicación.
// Se utiliza PasswordHasher para hashear las contraseñas de los usuarios.
// Revisa si los datos ya existen para evitar duplicados.
// Los datos incluyen:
// - Roles: Admin y User
// - Categorías: Varias categorías de productos
// - Usuarios: Un usuario administrador y un usuario regular
// - Productos: Varios productos de ejemplo en diferentes categorías
// Finalmente, guarda los cambios en el contexto de la base de datos.
